...
/**
 * MapStruct mapper responsible for converting between {@link Game} entity
 * and its corresponding DTOs such as {@link GameResponse}.
 * <p>
 * This mapper is registered as a Spring bean (via {@code componentModel = "spring"})
 * and is automatically implemented by MapStruct at build time.
 * </p>
 */
