...
/**
 * An implementation for the {@link GameService} interface.
 * Provides methods for retrieving, creating & updating games.
 */
@Service
...
public class GameServiceImpl implements GameService {
     ...
     * <p>
     * Supported filters are included in the {@link GameServiceImpl#getFilterFields()}.
     * If no {@code filters} are provided, all games are returned, based on the provided {@code pagination parameters}.
     * </p>
     *
    ...
    public PageResponse<GameResponse> getAll(int page, int size, Map<String, Object> filters) {
        ...
        Map<String, Object> parsedFilters = FilteringHelper.parseFilters(new ConcurrentHashMap<>(filters), getFilterFields());
