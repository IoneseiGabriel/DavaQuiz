...
/**
 * Service responsible for authenticating users and issuing JWT access tokens.
 * The service also integrates with LoginRateLimiter to enforce IP based rate limiting.
 */
@Service
