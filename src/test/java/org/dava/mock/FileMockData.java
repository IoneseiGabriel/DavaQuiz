...
public class FileMockData {
    public static final MockMultipartFile VALID_FILE = new MockMultipartFile(
            "file",
            "validFile.webp",
            "image/webp",
            "image".getBytes());

    public static final MockMultipartFile FILE_WITH_INVALID_CONTENT_TYPE = new MockMultipartFile(
            "file",
            "invalidFile.txt",
            String.valueOf(MediaType.TEXT_PLAIN),
            "txt".getBytes());

    public static final MockMultipartFile EMPTY_FILE = new MockMultipartFile(
            "file",
            "invalidFile.jpeg",
            String.valueOf(MediaType.IMAGE_JPEG),
            "".getBytes());

    public static final MockMultipartFile FILE_WITH_NO_CONTENT_TYPE = new MockMultipartFile(
            "file",
            "invalidFile.jpeg",
            null,
            "".getBytes());
    ...
    public static MockMultipartFile getTooBigFile() {
        byte[] size = new byte[11 * 1024 * 1024]; // 11MB
