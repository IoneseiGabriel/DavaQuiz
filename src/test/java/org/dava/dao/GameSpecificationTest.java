...
class GameSpecificationTest {
  ...
  @Mock Path<Object> statusPath;

  @Mock Path<Object> titlePath;

  @Mock Expression<String> lowerTitleExpression;

  @Mock Path<Object> createdAtPath;
  ...
  void createSpecificationWithNullOrEmptyFiltersReturnNull() {
    Assertions.assertAll(
        "Check Create Specifications With Null Or Empty Filters",
  ...
  void createSpecificationWithInvalidFiltersThrowsIllegalArgumentException() {
    assertThrows(
        ...
        () -> GameSpecification.createSpecification(invalidFilter),
  ...
  void equalsToDateWithValidDateFilterReturnsSpecification() {
    ...
    when(cb.between(any(), any(OffsetDateTime.class), any(OffsetDateTime.class)))
