...
class LoginRateLimiterTest {
    ...
    @Test
    void registerFailed_shouldRemoveExpiredAttemptsAndBlockWithinWindow() throws InterruptedException {
    ...
    @Test
    void checkAllowed_shouldThrowWhileBlockedAndStopThrowingAfterBlockExpires() throws InterruptedException {
